	...
	default:
		...
		case '/': // Prefix: "/tasks"
			...
			if len(elem) == 0 {
				...
				case "PATCH":
					s.handlePartiallyUpdateTaskRequest([0]string{}, elemIsEscaped, w, r)
				case "POST":
					s.handleCreateTaskRequest([0]string{}, elemIsEscaped, w, r)
				case "PUT":
					s.handleUpdateTaskRequest([0]string{}, elemIsEscaped, w, r)
				default:
					s.notAllowed(w, r, "GET,PATCH,POST,PUT")
				}
		...
		case '/': // Prefix: "/tasks"
			...
			if len(elem) == 0 {
				...
				case "GET":
					...
					return r, true
				case "PATCH":
					r.name = "PartiallyUpdateTask"
					r.summary = "Partially update a task"
					r.operationID = "partiallyUpdateTask"
					r.pathPattern = "/tasks"
					r.args = args
					r.count = 0
					return r, true
