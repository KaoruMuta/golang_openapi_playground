...
func encodePartiallyUpdateTaskResponse(response *PartiallyUpdateTaskNoContent, w http.ResponseWriter, span trace.Span) error {
	w.WriteHeader(204)
	span.SetStatus(codes.Ok, http.StatusText(204))
...
func encodeUpdateTaskResponse(response *UpdateTaskNoContent, w http.ResponseWriter, span trace.Span) error {
	w.WriteHeader(204)
	span.SetStatus(codes.Ok, http.StatusText(204))
